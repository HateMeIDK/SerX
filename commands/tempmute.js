...
module.exports = {
    ...
    execute: async(message, args)=>{
        ...
        if(time == undefined || !(time >= 15000 && time <= 2678400000)){
            return await message.channel.send(errorEmbed(guild.locale, "invalid_tm_time"));
        }
